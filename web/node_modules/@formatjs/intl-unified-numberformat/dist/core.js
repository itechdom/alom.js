...
var UnifiedNumberFormat = /** @class */ (function () {
    function UnifiedNumberFormat(locales, _a) {
        ...
        if (style === 'unit') {
            ...
            var resolvedLocale = intl_utils_1.findSupportedLocale(localesToLookup, UnifiedNumberFormat.__unitLocaleData__);
            if (!resolvedLocale) {
    ...
    UnifiedNumberFormat.supportedLocalesOf = function () {
        ...
        return intl_utils_1.supportedLocalesOf(args[0], UnifiedNumberFormat.__unitLocaleData__);
    };
