...
var FormattedHTMLMessage = /** @class */ (function (_super) {
    ...
    FormattedHTMLMessage.prototype.render = function () {
        ...
        return (React.createElement(injectIntl_1.Context.Consumer, null, function (intl) {
            ...
            var formatHTMLMessage = intl.formatHTMLMessage, Text = intl.textComponent;
            var _a = _this.props, id = _a.id, description = _a.description, defaultMessage = _a.defaultMessage, rawValues = _a.values, 
            // This is bc of TS3.3 doesn't recognize `defaultProps`
            _b = _a.tagName, 
            // This is bc of TS3.3 doesn't recognize `defaultProps`
            Component = _b === void 0 ? Text || 'span' : _b, children = _a.children;
